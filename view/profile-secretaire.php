		...
		<div class="col-md-12 col-xd-12 space">
			<form method="get" action="">
				...
				<div class="form-group">
					...
					<a href="imprimer-Sec.php" class="btn btn-primary">Imprimer</a>
					<a href="ajouter-rs.php" class="btn btn-primary">Ajouter</a>
				</div>				
				</div>
			</form>
		</div>
						...
						<div class="table-responsive table--no-card m-b-30">
							<table class="table table-striped">
								...
								<tbody>
									...
									<!--liens -->
									<td><a onclick="return confirm('Etes-vous sûre...?');" href="../model/supprimer-rapport.php?id=<?php echo($et['id'])?>" class="btn btn-danger">Supprimer</a><a href="../view/editer-sec.php?id=<?php echo($et['id'])?>" class="btn btn-primary">Editer</a></td>
												</tr>	
										<?php } ?>	
								</tbody>
							</table>
