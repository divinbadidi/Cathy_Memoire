				...
				<div class="panel panel-info spacer">
					...
					<div class="panel-body">
						<table class="table table-striped">
							<thead>
								<tr>
									<th>FICHE</th><th>NOM-COMPLET</th><th>SEXE</th><th>TELEPHONE</th><th>AGE</th><th>CATEGORIE</th><th>ADRESSE</th><th>SYMPTOME</th><th>GS</th><th>SERVICE</th><th>TEMPERATURE</th><th>DATE</th><th>RAPPORT</th><th>OPERATION</th>
								</tr>
							</thead>
							<tbody>
								...
								<!--liens -->
								<td><a onclick="return confirm('Etes-vous sûre...?');" href="../model/supprimer-patient.php?id=<?php echo($et['Num_fiche'])?>" class="btn btn-danger">Supprimer</a><a href="../view/editer-Patient.php?id=<?php echo($et['Num_fiche'])?>" class="btn btn-primary">Editer</a></td>
											</tr>	
									<?php } ?>	
							</tbody>
						</table>
