		...
		<div class="col-md-12 col-xd-12 space">
			<form method="get" action="">
				...
				<div class="form-group">
					...
					<a href="imprimer-pediatrie.php" class="btn btn-primary">Imprimer</a>
					...
					<div class="panel-body">
						<div class="table-responsive table--no-card m-b-30">
							<table class="table table-striped">
								<thead>
									<tr>
										<th>FICHE</th><th>NOM_COMPLET</th><th>SEXE</th><th>TELEPHONE</th><th>AGE</th><th>CATEGORIE</th><th>ADRESSE</th><th>SYMPTOME</th><th>GS</th><th>TEMPERATURE</th><th>DATE</th><th>HOSPITALISATION</th><th>RAPPORT</th>
									</tr>
								</thead>
								<tbody>
...
<?php
	}else if($_SESSION['service']=='chirurgie'){
		header("location:profile-chirurgie.php");
	}else if($_SESSION['service']=="Secretariat"){
		header("location:profile-secretaire.php");
	}else if($_SESSION['service']=="Medecin-directeur"){
		header("location:profile-medecin-directeur.php");
	}else if($_SESSION['service']=="directeur-general"){
		header("location:profile-dg.php");
	}
  ?>